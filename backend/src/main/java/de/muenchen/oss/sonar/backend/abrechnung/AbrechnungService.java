...
/**
 * Service for the Abrechnung aggregate.
 * <p>
 * No entity leaves it: open-in-view is disabled, so the collections of the aggregate can only be
 * initialized while the persistence session is open. Entities are therefore mapped inside the
 * transaction.
 * </p>
 */
@Service
