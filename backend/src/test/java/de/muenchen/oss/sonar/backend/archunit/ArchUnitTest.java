package de.muenchen.oss.sonar.backend.archunit;
...
import de.muenchen.oss.sonar.backend.archunit.rules.Rules;
...
public class ArchUnitTest {
    ...
    static void init() {
        allTestClasses = new ClassFileImporter()
                ...
                .importPackages(SonarApplication.class.getPackage().getName());
    }
